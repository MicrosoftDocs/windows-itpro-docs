...
##### [How to Deploy the App-V Client [5.1GB18030]](how-to-deploy-the-app-v-client-51gb18030.md)
...
##### [How to Install the Sequencer [5.1Beta, GB18030]](how-to-install-the-sequencer-51beta-gb18030.md)
...
##### [How to Install the Publishing Server on a Remote Computer[5..1]](how-to-install-the-publishing-server-on-a-remote-computer51.md)
...
##### [How to Sequence a New Application with App-V 5.1 [Beta, GB18030]](how-to-sequence-a-new-application-with-app-v-51-beta-gb18030.md)
...
##### [How to Add or Upgrade Packages by Using the Management Console [5.1, GB18030]](how-to-add-or-upgrade-packages-by-using-the-management-console-51-gb18030.md)
...
### [Getting Started with App-V 5.0  [RTM]](getting-started-with-app-v-50--rtm.md)
...
### [Planning for App-V 5.0 [RC]](planning-for-app-v-50-rc.md)
...
##### [How to Deploy the App-V Client [GB18030]](how-to-deploy-the-app-v-client-gb18030.md)
...
##### [How to Install the Sequencer [Beta, GB18030]](how-to-install-the-sequencer-beta-gb18030.md)
...
##### [How to Deploy the App-V 5.0 Server [5.0SP3]](how-to-deploy-the-app-v-50-server-50sp3.md)
...
##### [How to Sequence a New Application with App-V 5.0 [Beta, GB18030]](how-to-sequence-a-new-application-with-app-v-50-beta-gb18030.md)
##### [How to Modify an Existing Virtual Application Package [Beta]](how-to-modify-an-existing-virtual-application-package-beta.md)
...
##### [How to Connect to the Management Console [Beta]](how-to-connect-to-the-management-console-beta.md)
##### [How to Add or Upgrade Packages by Using the Management Console [Beta, GB18030]](how-to-add-or-upgrade-packages-by-using-the-management-console-beta-gb18030.md)
##### [How to Configure Access to Packages by Using the Management Console [5.0]](how-to-configure-access-to-packages-by-using-the-management-console-50.md)
##### [How to Publish a Package by Using the Management Console [5.0]](how-to-publish-a-package-by-using-the-management-console-50.md)
##### [How to Delete a Package in the Management Console [Beta]](how-to-delete-a-package-in-the-management-console-beta.md)
...
##### [How to View and Configure Applications and Default Virtual Application Extensions by Using the Management Console [Beta]](how-to-view-and-configure-applications-and-default-virtual-application-extensions-by-using-the-management-console-beta.md)
...
##### [How to Configure the Client to Receive Package and Connection Groups Updates From the Publishing Server [Beta]](how-to-configure-the-client-to-receive-package-and-connection-groups-updates-from-the-publishing-server-beta.md)
#### [Migrating from a Previous Version [App-V 5.0]](migrating-from-a-previous-version-app-v-50.md)
...
##### [How to Load the PowerShell Cmdlets and Get Cmdlet Help [5.0 SP3]](how-to-load-the-powershell-cmdlets-and-get-cmdlet-help-50-sp3.md)
...
##### [How to Sequence a Package  by Using PowerShell [5.0]](how-to-sequence-a-package--by-using-powershell-50.md)

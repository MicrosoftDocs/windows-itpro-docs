...
###### [Edit the Configuration.mof File [MBAM_25]](edit-the-configurationmof-file-mbam-25.md)
###### [Create or Edit the Sms_def.mof File [MBAM_25]](create-or-edit-the-sms-defmof-file-mbam-25.md)
...
#### [Hiding the Default BitLocker Drive Encryption Item in Control Panel [MBAM_25]](hiding-the-default-bitlocker-drive-encryption-item-in-control-panel-mbam-25.md)
### [Deploying the MBAM 2.5 Client](deploying-the-mbam-25-client.md)
#### [How to Deploy the MBAM Client to Desktop or Laptop Computers [MBAM_25]](how-to-deploy-the-mbam-client-to-desktop-or-laptop-computers-mbam-25.md)
#### [How to Enable BitLocker by Using MBAM as Part of a Windows Deployment[MBAM_25]](how-to-enable-bitlocker-by-using-mbam-as-part-of-a-windows-deploymentmbam-25.md)
...
#### [How to Manage User BitLocker Encryption Exemptions [MBAM_25]](how-to-manage-user-bitlocker-encryption-exemptions-mbam-25.md)
...
##### [How to Reset a TPM Lockout [MBAM_25]](how-to-reset-a-tpm-lockout-mbam-25.md)
##### [How to Recover a Drive in Recovery Mode [MBAM_25]](how-to-recover-a-drive-in-recovery-mode-mbam-25.md)
##### [How to Recover a Moved Drive [MBAM_25]](how-to-recover-a-moved-drive-mbam-25.md)
##### [How to Recover a Corrupted Drive [MBAM_25]](how-to-recover-a-corrupted-drive-mbam-25.md)
##### [How to Determine BitLocker Encryption State of Lost Computers [MBAM_25]](how-to-determine-bitlocker-encryption-state-of-lost-computers-mbam-25.md)
#### [How to Use the Self-Service Portal to Regain Access to a Computer [MBAM_25]](how-to-use-the-self-service-portal-to-regain-access-to-a-computer-mbam-25.md)

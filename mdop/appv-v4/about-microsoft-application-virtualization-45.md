...
-   Extended Scalability: Choose among three flexible deployment modes:
    ...
    3.  Standalone mode enables virtual applications to run without streaming and is interoperable with Microsoft Systems Management Server and Microsoft Endpoint Configuration Manager and third-party ESD systems.

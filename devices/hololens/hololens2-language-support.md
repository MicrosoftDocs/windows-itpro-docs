...
Some features of HoloLens 2 use the Windows display language. Windows display language affects the following settings for Windows and for apps that support localization:

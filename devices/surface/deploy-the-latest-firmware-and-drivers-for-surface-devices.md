...
|             |                 |          | Indicates key date and sequence information. <br> **19:**  Signifies the year (2019)<br>**003**: Signifies that it’s the third release of 2019<br>**07**: Signifies the product version number. (Surface Pro 6 is officially the seventh version of Surface Pro.) | Indicates  release history of the MSI file. In this example, **0** shows it's the first release of version 1900307 and has not been re-released for any reason. |

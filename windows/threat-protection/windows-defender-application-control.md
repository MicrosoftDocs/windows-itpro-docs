...
For more information, see [Steps to deploy Windows Defender Application Control](windows\device-security\device-guard\steps-to-deploy-windows-defender-application-control.md).  

...
## Groups and tags
You can filter the list based on the grouping and tagging that you've added to individual machines. For more information, see [Manage machine group and tags](machines-view-overview-windows-defender-advanced-threat-protection.md#manage-machine-group-and-tags).

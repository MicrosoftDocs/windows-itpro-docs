...
>**Note**
With Windows 10, version 1607, the process of registrating UE-V templates is required for all inbox and custom templates. This provides flexibility for only deploying the required templates.

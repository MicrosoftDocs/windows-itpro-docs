...
**Note**  
For information about the new functionality of App-V 5.1 sequencer, see the **Sequencer Improvements** section of [About App-V 5.1](appv-about-appv.md).

 

The computer that runs the App-V 5.1 sequencer must meet the minimum system requirements. For a list of these requirements, see [App-V 5.1 Supported Configurations](appv-supported-configurations.md).
...
For a list of the client minimum requirements see [App-V 5.1 Prerequisites](appv-prerequisites.md).

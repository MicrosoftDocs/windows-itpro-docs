...
2. Click the **Policy** workspace. In the middle pane, click **Configuration Policies**, and then click **Add** in the details pane.
    ...
    ![Shows the UI for this step](images/waas-wufb-intune-step2.png)
...
7. In the **Value** box, type **1**, and then click **OK**.
    ...
    ![Settings for this policy](images/waas-wufb-intune-step7.png)
...
19.	Click **OK** to save the setting.
    ...
    ![Settings for CBB2 policy](images/waas-wufb-intune-step19.png)
...
7. In the **Value** box, type **0**, and then click **OK**.
    ...
    ![Settings for this policy](images/waas-wufb-intune-cb2.png)
...
11.	In the **Value** box, type **14**, and then click **OK**.
    ...
    ![Settings for this policy](images/waas-wufb-intune-step11.png)
...
11.	In the **Value** box, type **0**, and then click **OK**.
    ...
    ![Settings for this policy](images/waas-wufb-intune-cbb1.png)
...
11.	In the **Value** box, type **30**, and then click **OK**.
    ...
    ![Settings for this policy](images/waas-wufb-intune-cbb2.png)

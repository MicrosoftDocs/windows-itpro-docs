...
<p>**Important**<br>Turning off Wi-Fi Sense stops employees from connecting automatically to open hotspots.
...
<!--has this policy changed names? If so, need to also change the image-->

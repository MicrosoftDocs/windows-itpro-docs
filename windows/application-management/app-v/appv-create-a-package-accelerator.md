...
11. On the **Completion** page, select **Close**.
    ...
    >[!IMPORTANT]
    >You should always digitally sign the package accelerator to ensure that the Package Accelerator is secure and can be verified by a publisher during application.

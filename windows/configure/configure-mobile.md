...
| [Use Windows Configuration Designer to configure Windows 10 Mobile devices](provisioning-configure-mobile.md) | Provisioning packages offer flexibility in deciding which settings to apply to a device. |

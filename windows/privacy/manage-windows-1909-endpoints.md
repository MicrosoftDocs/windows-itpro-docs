...
||The following endpoints are related to Cortana and Live Tiles. If you turn off traffic for this endpoint, you will block updates to Cortana greetings, tips, and Live Tiles.|HTTP|www.bing.com*|
|||HTTP|www.bing.com/client/config|
|||TLSV1.2|fp.msedge.net|

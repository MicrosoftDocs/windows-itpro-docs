...
| [Turn on or off expedited Windows quality update preferences](../operate/windows-autopatch-windows-quality-update-overview.md#expedited-releases) | :heavy_check_mark: | :x: |

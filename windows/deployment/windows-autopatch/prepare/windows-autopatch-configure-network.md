...
Windows Autopatch supports and recommends the configuration and validation of Delivery Optimization along with your adoption of the service. For more information, see [What is Delivery Optimization?](/windows/deployment/do/waas-delivery-optimization)

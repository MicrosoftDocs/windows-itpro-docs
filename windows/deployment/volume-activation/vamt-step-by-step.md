...
|[Scenario 3: KMS Client Activation](scenario-kms-activation-vamt.md) |Describes how to use VAMT to configure client products for Key Management Service (KMS) activation. By default, volume license editions of Windows 10, Windows Vista, Windows&reg; 7, Windows 8, Windows Server 2008, Windows Server 2008 R2, or Windows Server&reg; 2012, and Microsoft&reg; Office 2010 use KMS for activation. |

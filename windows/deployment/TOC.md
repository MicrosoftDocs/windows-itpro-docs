...
##### [Get started with Configuration Manager](deploy-windows-sccm/get-started-with-configuration-manager.md)
##### Deploy Windows 10 with Configuration Manager
###### [Integrate Configuration Manager with MDT](deploy-windows-sccm/integrate-configuration-manager-with-mdt.md)
...
###### [Create a task sequence with Configuration Manager and MDT](deploy-windows-sccm/create-a-task-sequence-with-configuration-manager-and-mdt.md)
...
###### [Perform an in-place upgrade to Windows 10 using Configuration Manager](deploy-windows-sccm/upgrade-to-windows-10-with-configuraton-manager.md)

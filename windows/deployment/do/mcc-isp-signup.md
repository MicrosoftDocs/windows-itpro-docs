...
> [!NOTE]
> Microsoft Connected Cache is a completely free service for operators. None of the resources created in Azure will incure any charges.
> Please be aware of any additional services that may be selected as part of the Azure sign up process.

...
For information about features that have been removed in a specific release, see [Features removed](features-lifecycle.md#features-removed).

## Features we’re no longer developing

The following features are longer being actively developed, and might be removed in a future update. Some features have been replaced with other features or functionality and some are now available from other sources.

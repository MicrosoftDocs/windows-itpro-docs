...
| Bing IME | Bing IME is still downloadable but is no longer being developed. | 1909 |
| Package State Roaming (PSR) |  PSR allows non-Microsoft developers to access roaming data on devices. It enables developers of UWP applications to write data to Windows and synchronize it to other instantiations of Windows for that user. <br>&nbsp;<br>Azure App Service is a recommended replacement. It is widely supported, well documented, reliable, and supports cross-platform/cross-ecosystem scenarios such as iOS, Android and web. | 1909 |

...
| Bing IME | Support for Bing Input Method Editor (IME), officially named 必应 Bing 输入法, ended on July 08, 2019.  Microsoft is no longer offering Bing IME for download, nor will Microsoft provide technical support or updates for Bing IME. If you need to type Simplified Chinese, please use Microsoft Chinese Pinyin IME, which is safer and easier to use. See [this support article](https://support.microsoft.com/help/2893446/support-for-bing-ime-for-windows-has-ended) for more information.  | 1909 |
| Taskbar settings roaming | Roaming of taskbar settings is removed in this release. This feature was announced as deprecated in Windows 10, version 1903. | 1909 |

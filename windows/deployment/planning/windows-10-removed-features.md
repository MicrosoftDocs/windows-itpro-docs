...
| Paint 3D: Publish to Remix 3D| The functionality within Paint 3D to publish to Remix 3D through the Remix panel  will be removed. The upload and publish functionality will continue to be available through the Paint 3D file menu.  | 1909 |

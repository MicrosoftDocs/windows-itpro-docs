...
For more details about Microsoft Endpoint Configuration Manager support for Windows 10, see [Deploy Windows 10 with System Center 2012 R2 Configuration Manager](../deploy-windows-cm/deploy-windows-10-with-system-center-2012-r2-configuration-manager.md).

...
| **WUDeadlineNoAutoRestart** |  | No | | Currently, data isn't gathered to populate this field. Devices will not automatically restart outside of active hours until the deadline is reached - It is 1 by default and indicates enabled, 0 indicates disabled |
...
| **WUFeaturePauseEndTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime)  | No | `43965.3930958102` | Currently, data isn't gathered to populate this field. The time WU Feature Update Pause will end, if activated, else null. |
| **WUFeaturePauseStartTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime)  | No | `43965.3930958102` | Currently, data isn't gathered to populate this field. The time WU Feature Update Pause was activated, if activated, else null. Feature Updates will be paused for 35 days from the specified start date. |
...
| **WUPauseUXDisabled** | |  No |  | Currently, data isn't gathered to populate this field. This policy allows the IT admin to disable the Pause Updates feature. When this policy is enabled, the user cannot access the Pause updates' feature. Supported values 0, 1. |
...
| **WUQualityPauseEndTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime)  | No | `43965.3930958102` | Currently, data isn't gathered to populate this field. The time WU Quality Update Pause will end, if activated, else null. |
| **WUQualityPauseStartTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime)  | No | `43965.3930958102` | Currently, data isn't gathered to populate this field. The time WU Quality Update Pause was activated; if activated; else null. |
...
| **WUUXDisabled** | |  No | | Currently, data isn't gathered to populate this field. This policy allows the IT admin to remove access to scan Windows Update. When this policy is enabled, the user cannot access the Windows Update scan, download, and install features. Default is 0. Supported values 0, 1. |

...
**Azure Active Directory** is the directory that Azure uses. Azure Active Directory (AAD) is a separate service which sits by itself and is used by all of Azure and also Office 365.

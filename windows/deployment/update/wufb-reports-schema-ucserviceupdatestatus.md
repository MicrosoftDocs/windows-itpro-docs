...
| **DeploymentApprovedTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime) | No | `44695.3930958102` | This field applies to drivers only. Date and time of the update approval |
...
| **DeploymentRevokeTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime) | No | `44695.3930958102` | This field applies to drivers only. Date and time the update was revoked |
...
| **OfferReadyTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime) | No | `44695.3930958102` | DateTime of OfferReady transition. If empty, not yet been offered. |
| **PolicyCreatedTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime) | No | `44695.3930958102` | This field applies to drivers only. Date and time the policy was created |
...
| **ProjectedOfferReadyTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime) | No | `44695.3930958102` | Projected time update will be offered to device. If empty, unknown. |
...
| **ServiceSubstateTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime) | No | `44695.3930958102` | Date and time of last ServiceSubstate transition. |
| **SourceSystem** | [string](/azure/data-explorer/kusto/query/scalar-data-types/string) | No | `Azure` |  |
| **TargetBuild** | [string](/azure/data-explorer/kusto/query/scalar-data-types/string) | No | `10.0.18363.836` | The full build for the content this event is tracking. For Windows 10, this  [string](/azure/data-explorer/kusto/query/scalar-data-types/string) | corresponds to "10.0.Build.Revision" |
...
| **TimeGenerated [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime) |  | `44695.3930958102` | Time the snapshot ran can also be the same as EventDateTimeUTC in some cases. |
...
| **UpdateRecommendedTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime) | No | `44695.3930958102` | This field applies to drivers only. Date and time when the update was recommended to the device |
| **UpdateReleaseTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime) | No | `44695.3930958102` | Currently, data isn't gathered to populate this field. The release date of the update |
...
| **UpdateVersionTime [UTC]** | [datetime](/azure/kusto/query/scalar-data-types/datetime) | No | `44695.3930958102` | This field applies to drivers only. Update version date time stamp for drivers and firmware |

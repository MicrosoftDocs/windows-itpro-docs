...
You can [**download the script here**](download.microsoft.com/download/7/e/c/7ec903d0-4934-4910-a138-e010dc30b1c1/UpdateComplianceConfigurationScript-master.zip"]). Keep reading to learn how to configure the script and interpret error codes that are output in logs for troubleshooting.

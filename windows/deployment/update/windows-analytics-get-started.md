...
| AllowDeviceNameInTelemetry (in Windows 10) |	In Windows 10 1803 and later, a separate opt-in is required to enable devices to continue to send the device name. |

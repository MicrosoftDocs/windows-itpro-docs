...
***(Applies to: Windows 11 & Windows 10 using [Update Compliance](wufb-reports-overview.md) and the [Microsoft 365 admin center](/microsoft-365/admin/admin-overview/admin-center-overview))***
...
Use [Update Compliance](wufb-reports-overview.md) to display additional data about the status of Windows updates.

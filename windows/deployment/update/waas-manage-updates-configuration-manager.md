...
> [!NOTE]
> This topic focuses on updating and upgrading Windows 10 after it has already been deployed. To use Configuration Manager to upgrade your systems from the Windows 8.1, Windows 8, or Windows 7 operating system, see [Perform an in-place upgrade to Windows 10 using Configuration Manager](https://docs.microsoft.com/windows/deployment/upgrade/upgrade-to-windows-10-with-system-center-configuraton-manager).
...
- **Windows Server Update Service (WSUS)**. Configuration Manager must have the Software update point site system role added and be configured to receive updates from WSUS.
...
1. In the Create Device Collection Wizard, in the **name** box, type **Windows 10 – All Current Branch for Business**.

1. Click **Browse** to select the limiting collection, and then click **All Systems**.

1. In **Membership rules**, click **Add Rule**, and then click **Query Rule**.

1. Name the rule **CBB Detection**, and then click **Edit Query Statement**.

1. On the **Criteria** tab, click the **New** icon.

    ![Example of UI](images/waas-sccm-fig4.png)

1. In the **Criterion Properties** dialog box, leave the type as **Simple Value**, and then click **Select**.

1. In the **Select Attribute** dialog box, from the **Attribute class** list, select **System Resource**. From the **Attribute** list, select **OSBranch**, and then click **OK**.
...
1. Now that the **OSBranch** attribute is correct, verify the operating system version.

1. On the **Criteria** tab, click the **New** icon again to add criteria.

1. In the **Criterion Properties** dialog box, click **Select**.

1. From the **Attribute class** list, select **System Resource**. From the **Attribute** list, select **Operating System Name and Version**, and then click **OK**.

     ![Example of UI](images/waas-sccm-fig7.png)

1. In the **Value** box, type **Microsoft Windows NT Workstation 10.0**, and then click **OK**.

     ![Example of UI](images/waas-sccm-fig8.png)

1. In the **Query Statement Properties** dialog box, you see two values. Click **OK**, and then click **OK** again to continue to the Create Device Collection Wizard.

1. Click **Summary**, and then click **Next**.
...
1. In the Create Device Collection Wizard, in the **name** box, type **Ring 4 Broad business users**.

1. Click **Browse** to select the limiting collection, and then click **Windows 10 – All Current Branch for Business**.

1. In **Membership rules**, click **Add Rule**, and then click **Direct Rule**.

1. In the **Create Direct Membership Rule Wizard** dialog box, click **Next**.

1. In the **Value** field, type all or part of the name of a device to add, and then click **Next**.

1. Select the computer that will be part of the **Ring 4 Broad business users** deployment ring, and then click **Next**.

1. Click **Next**, and then click **Close**.

1. In the **Create Device Collection Wizard** dialog box, click **Summary**.
...
1. Name the plan **Ring 4 Broad business users Servicing Plan**, and then click **Next**.

1. On the **Servicing Plan page**, click **Browse**. Select the **Ring 4 Broad business users** collection, which you created in the [Create collections for deployment rings](#create-collections-for-deployment-rings) section, click **OK**, and then click **Next**.
...
1. On the **Distribution Points** page, from the **Add** list, select **Distribution Point**.
...
1. Click **Summary**, click **Next** to complete the servicing plan, and then click **Close**.
...
1. On the **Data Source** page, type the path of the extracted .iso file of the new version of Windows 10 you’re deploying, and then click **Next**.
...
1. On the **General** page, in the **Name** field, type the name of the folder (**Windows 10 Enterprise - Version 1607** in this example). Set the **Version** to **1607**, and then click **Next**.

1. On the **Summary** page, click **Next** to create the package.
...
1. In the Distribute Content Wizard, on the **General** page, click **Next**.

1. On the **Content Destination** page, click **Add**, and then click **Distribution Point**.

1. In the **Add Distribution Points** dialog box, select the distribution point that will serve the clients receiving this package, and then click **OK**.

1. On the **Content Destination** page, click **Next**.

1. On the **Summary** page, click **Next** to distribute the content to the selected distribution point.
...
1. In the Create Task Sequence Wizard, on the **Create a new task sequence** page, select **Upgrade an operating system from upgrade package**, and then click **Next**.

1. On the **Task Sequence Information** page, in **Task sequence name**, type **Upgrade Windows 10 Enterprise – Version 1607**, and then click **Next**.

1. On the **Upgrade the Windows Operating system** page, click **Browse**, select the deployment package you created in the previous steps, and then click **OK**.

1. Click **Next**.

1. On the **Include Updates** page, select **Available for installation – All software updates**, and then click **Next**.

1. On the **Install Applications** page, click **Next**.

1. On the **Summary** page, click **Next** to create the task sequence.
...
1. In the Deploy Software Wizard, on the **General** page, click **Browse**. Select the target collection, click **OK**, and then click **Next**.

1. On the **Deployment Settings** page, for **purpose**, select **Required**, and then click **Next**.

1. On the **Scheduling** page, select the **Schedule when this deployment will become available** check box (it sets the current time by default). For **Assignment schedule**, click **New**.

1. In the **Assignment Schedule** dialog box, click **Schedule**.

1. In the **Custom Schedule** dialog box, select the desired deadline, and then click **OK**.

1. In the **Assignment Schedule** dialog box, click **OK**, and then click **Next**.

1. On the **User Experience** page, in the **When the scheduled assignment time is reached, allow the following activities to be performed outside of the maintenance window** section, select **Software Installation** and **System restart** (if required to complete the installation), and then click **Next**.

1. Use the defaults for the remaining settings.

1. Click **Summary**, and then click **Next** to deploy the task sequence.

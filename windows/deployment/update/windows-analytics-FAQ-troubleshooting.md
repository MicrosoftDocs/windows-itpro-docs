...
2.  Disable the Commercial Data Opt-in Key on computers running Windows 7 SP1 or 8.1. On computers running Windows 10, set the diagnostic data level to **Security**:
  ...
  **Windows 10**: Follow the instructions in the [Configure Windows diagnostic data in your organization](../privacy/configure-windows-diagnostic-data-in-your-organization.md) topic.

...
>[!NOTE]
>In case of using Remote Desktop Protocol connections, only active RDP sessions are considered as logged on users. Devices, that do not have locally logged on users or active RDP sessions, will be restarted. 
...
>In case of using RDP, only active RDP sessions are considered as logged on users.

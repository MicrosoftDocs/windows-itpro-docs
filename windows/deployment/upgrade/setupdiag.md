...
1. BitLockerHardblock - C30152E2-938E-44B8-915B-D1181BA635AE
    - This is an upgrade block when the target OS doesn't support BitLocker, yet the host OS has BitLocker enabled.

1. VHDHardblock - D9ED1B82-4ED8-4DFD-8EC0-BE69048978CC
...
1. PortableWorkspaceHardblock - 5B0D3AB4-212A-4CE4-BDB9-37CA404BB280
...
1. AuditModeHardblock - A03BD71B-487B-4ACA-83A0-735B0F3F1A90
...
1. SafeModeHardblock - 404D9523-B7A8-4203-90AF-5FBB05B6579B
    - This block indicates that the host OS is booted to Safe Mode, where upgrade isn't supported.

1. InsufficientSystemPartitionDiskSpaceHardblock - 3789FBF8-E177-437D-B1E3-D38B4C4269D1
...
1. CompatBlockedApplicationAutoUninstall - BEBA5BC6-6150-413E-8ACE-5E1EC8D34DD5
    - This rule indicates there's an application that needs to be uninstalled before setup can continue.

1. CompatBlockedApplicationDismissable - EA52620B-E6A0-4BBC-882E-0686605736D9
    - When running setup in /quiet mode, there are dismissible application messages that turn into blocks unless the command line also specifies "/compat ignorewarning".  This rule indicates setup was executed in /quiet mode but there's an application dismissible block message that has prevented setup from continuing.
1. CompatBlockedApplicationManualUninstall - 9E912E5F-25A5-4FC0-BEC1-CA0EA5432FF4
...
1. HardblockDeviceOrDriver - ED3AEFA1-F3E2-4F33-8A21-184ADF215B1B
...
1. HardblockMismatchedLanguage - 60BA8449-CF23-4D92-A108-D6FCEFB95B45
    - This rule indicates the host OS and the target OS language editions don't match.
1. HardblockFlightSigning - 598F2802-3E7F-4697-BD18-7A6371C8B2F8
...
1. DiskSpaceBlockInDownLevel - 6080AFAC-892E-4903-94EA-7A17E69E549E
    - This failure indicates the system ran out of disk space during the down-level operations of upgrade.
1. DiskSpaceFailure - 981DCBA5-B8D0-4BA7-A8AB-4030F7A10191
...
1. DeviceInstallHang - 37BB1C3A-4D79-40E8-A556-FDA126D40BC6
    - This failure rule indicates the system hung or bug checked during the device installation phase of upgrade.
1. DebugSetupMemoryDump - C7C63D8A-C5F6-4255-8031-74597773C3C6
...
1. DebugSetupCrash - CEEBA202-6F04-4BC3-84B8-7B99AED924B1
...
1. DebugMemoryDump - 505ED489-329A-43F5-B467-FCAAF6A1264C
...
- Performance improvement in searching **setupact.log** to determine correct log to parse.

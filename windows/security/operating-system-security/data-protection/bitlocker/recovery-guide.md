...
To force a recovery for the local computer, open an elevated command prompt and enter the following command:

```cmd
manage-bde.exe -forcerecovery <BitLockerVolume>
```

To force a recovery for a remote computer, open an elevated command prompt and enter the following command:

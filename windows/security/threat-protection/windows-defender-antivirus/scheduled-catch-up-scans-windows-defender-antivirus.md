...
Root | Randomize scheduled task times | Randomize the start time of the scan to any interval from 0 to 4 hours. This can be useful in VM or VDI deployments | Enabled

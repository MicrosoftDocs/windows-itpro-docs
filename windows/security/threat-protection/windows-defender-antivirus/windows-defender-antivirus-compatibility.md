...
If you are Using Windows Server, version 1803 and Windows 2019, you can enable passive mode following the steps below:
Set the following registry entry: 
- Path: HKLM\SOFTWARE\Policies\Microsoft\Windows Advanced Threat Protection 
- Name: ForceDefenderPassiveMode - Value: 1

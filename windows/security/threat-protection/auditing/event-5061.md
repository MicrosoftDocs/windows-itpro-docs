...
description: Describes security event 5061(S, F) Cryptographic operation. This event is generates when a cryptographic operation is performed using a Key Storage Provider.

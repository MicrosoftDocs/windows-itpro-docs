...
1. Make sure your organization meets all of the following requirements to manage tamper protection using Intune:
    ...
    - Your Windows machines must be running Windows 10, version [1903](https://docs.microsoft.com/windows/release-information/status-windows-10-1903) or later. (See [Windows 10 release information](https://docs.microsoft.com/windows/release-information/) for more details about releases.)

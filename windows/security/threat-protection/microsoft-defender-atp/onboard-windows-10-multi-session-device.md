...
> [!IMPORTANT]
> Welcome to Microsoft Defender for Endpoint, the new name for Microsoft Defender Advanced Threat Protection (Microsoft Defender ATP). Read more about this and other updates here. We'll be updating names in products and in the docs in the near future.

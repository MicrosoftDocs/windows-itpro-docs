...
><P> 1. Go to [Microsoft Update Catalog](http://www.catalog.update.microsoft.com/home.aspx).
><P> 2. Key-in the security update KB number that you need to download, then click **Search**.  

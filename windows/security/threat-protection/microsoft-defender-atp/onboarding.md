...
To onboard computers running previous versions of Windows Client, you need to connect them to Azure Monitor. For more details, please see [Connect Windows computers to Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/platform/agent-windows) and [Log Analytics agent overview](https://docs.microsoft.com/azure/azure-monitor/platform/log-analytics-agent).

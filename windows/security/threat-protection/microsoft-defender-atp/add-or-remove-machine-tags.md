...
description: Learn how to use the Add or Remove machine tags API to adds or remove tag for a specific machine in Microsoft Defender Advanced Threat Protection.

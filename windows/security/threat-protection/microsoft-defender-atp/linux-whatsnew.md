...
> [!WARNING]
> When upgrading the installed package from product version earlier than 100.90.70 to 100.90.70, the update may fail in Red Hat-based and SLES distributions. This is because of a major change in a file path. A temporary solution is to remove the older package, and then install the newer one. This issue does not exist in newer versions.

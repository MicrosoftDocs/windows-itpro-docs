...
| [Obtain an impersonation token for another user in the same session](/troubleshoot/windows-server/windows-security/seimpersonateprivilege-secreateglobalprivilege) | SeDelegateSessionUserImpersonatePrivilege|

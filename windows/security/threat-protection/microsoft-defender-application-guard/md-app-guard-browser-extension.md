...
ExceptionThrown | An unexpected exception was thrown. | &bull; [File a bug](aka.ms\wdag-fb) </br> &bull; Retry the operation
...
Main page navigation caught an unexpected error | An unexpected exception was thrown during the main page navigation. | &bull; [File a bug](aka.ms\wdag-fb) </br> &bull; Retry the operation
...
Unexpected response while processing trusted state | The extension was able to communicate with the companion app, but the API failed and a failure response code was sent back to the extension. | &bull; [File a bug](aka.ms\wdag-fb) </br> &bull; Check if Edge is working </br> &bull; Retry the operation

...
Windows Hello for Business has three deployment models: Cloud, Hybrid and, On-premises. Hybrid and On-premises deployment model has two trust models: *Key trust* or *certificate trust*.

...
- The first sign-in or unlock with Windows Hello for Business after provisioning and when attempting to access an on-premises resource on a Hybrid Azure AD joined device

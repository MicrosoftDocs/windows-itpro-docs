...
11. In the content pane, double-click **Impersonate a client after authentication**. Select **Define these policy settings** and click **OK**.  Click **Add User or Group...**.  In the **Add User or Group** dialog box, click **Browse**.  In the **Select Users, Computers, Service Accounts, or Groups** dialog box, type **Administrators;IIS_IUSRS;LOCAL SERVICE;NETWORK SERVICE;SERVICE**  in **User and group names**.  Click **OK** three times.

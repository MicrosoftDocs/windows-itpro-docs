...
### Use PowerShell to add a recovery password and back it up to Azure AD before enabling BitLocker
...
### Use PowerShell to add a recovery password and back it up to AD DS before enabling BitLocker
...
### Use PowerShell to enable BitLocker with a TPM protector

```powershell
Enable-BitLocker -MountPoint "C:" -EncryptionMethod XtsAes256 -UsedSpaceOnly -TpmProtector
```

### Use PowerShell to enable BitLocker with a TPM+PIN protector, in this case with a PIN set to 123456
...
[Microsoft BitLocker Administration and Management (MBAM)](https://docs.microsoft.com/microsoft-desktop-optimization-pack/)
...
[System Center Configuration Manager](https://docs.microsoft.com/sccm/osd/understand/task-sequence-steps#BKMK_PreProvisionBitLocker) *(Pre-provision BitLocker task sequence)*

[Enable BitLocker task sequence](https://docs.microsoft.com/sccm/osd/understand/task-sequence-steps#BKMK_EnableBitLocker)
...
[Microsoft Intune](https://www.microsoft.com/cloud-platform/microsoft-intune) *(Overview)*
...
*(Policy CSP: See [Security-RequireDeviceEncryption](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-security#security-requiredeviceencryption))*

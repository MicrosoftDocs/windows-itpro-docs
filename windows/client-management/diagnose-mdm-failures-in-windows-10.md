...
- MDMDiagReport.xml: contains a more detailed view into the MDM configurations, e.g enrollment variables, provisioning packages, multivariant conditions, etc. For more information about diagnosing provisioning packages, see [Diagnose provisioning packages](/windows/configuration/provisioning-packages/diagnose-provisioning-packages.md).

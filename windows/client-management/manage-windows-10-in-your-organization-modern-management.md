...
-   Avoid reimaging by using dynamic provisioning, enabled by a cloud-based device management services such as [Microsoft Autopilot (https://docs.microsoft.com/en-us/windows/deployment/windows-10-auto-pilot).

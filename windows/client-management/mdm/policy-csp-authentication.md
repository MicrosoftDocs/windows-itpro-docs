...
In the next major release of Windows 10, the default for this policy for consumers devices will be changed to off. This will only affect users that have not already set up a secondary authentication device.

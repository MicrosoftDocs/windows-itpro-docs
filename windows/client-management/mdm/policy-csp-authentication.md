...
<!--Description-->
> [!Warning]
> The Enable Fast First Sign-in feature is in preview mode only and not meant or recommended for production purposes. This setting is not currently supported.

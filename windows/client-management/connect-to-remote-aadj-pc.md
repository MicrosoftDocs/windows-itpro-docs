...
- Your local PC (where you are connecting from) must be either Azure AD joine or Hybrid Azure AD joined, if using WIndows 10 versio 1607 and above or Azure AD registered, if using Windows 10 version 2004 and above. Remote connections to an Azure AD joined PC from an unjoined device or a non-Windows 10 device are not supported. 

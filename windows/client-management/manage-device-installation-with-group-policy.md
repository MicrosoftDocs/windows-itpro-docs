...
![List of prevent Class GUID’s](images/device-installation-gpo-prevent-class-list.png)
...
![Allowed USB Device IDs list](images/device-installation-gpo-allow-device-id-list-usb.png)

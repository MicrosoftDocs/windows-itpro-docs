...
-   Provided a way for domain controllers to get the device authorization data during user sign on using Kerberos armoring, so what is left to do is configuring the access check on the domain controllers. This is done with authentication policies.

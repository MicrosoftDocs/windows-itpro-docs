...
6.  On the **Device Settings** screen, click **Windows Information Protection**, and then click **Next**.
    ...
    ![Create Configuration Item wizard, choose the Windows Information Protection settings](images/edp-sccm-devicesettings.png)
...
![Create Configuration Item wizard, choose your WIP-protection level](images/edp-sccm-appmgmt.png)

...
-   **Package Name (NTLM only)** \[Type = UnicodeString\]**:** The name of the LAN Manager sub-package ([**NTLM-family**](https://msdn.microsoft.com/en-us/library/cc236621.aspx) protocol name) that was used during logon. Possible values are:

...
<p> </p>
<h2><a id="Windows_Defender_client_error_codes"></a><a id="windows_defender_client_error_codes"></a><a id="WINDOWS_DEFENDER_CLIENT_ERROR_CODES"></a>Windows Defender client error codes</h2>
<p> If Windows Defender experiences any issues it will usually give you an error code to help you troubleshoot the issue.

Most often an error means there was a problem installing an update.
</p>
<p>This section provides the following information about Windows Defender client errors.<ul>
<li>The error code</li>
<li>The possible reason for the error</li>
<li>Advice on what to do now</li>
</ul>
</p>
<p>Use the information in these tables to help troubleshoot Windows Defender error codes.</p>
<table>
<tr>

...
>You can now use Upgrade Analytics to help manage your Windows upgrade process on devices running Windows 8.1 and Windows 7 (SP1), including being able to review several site discovery reports. Check out Upgrade Analytics from [here](https://technet.microsoft.com/en-us/itpro/windows/deploy/upgrade-analytics-get-started).
